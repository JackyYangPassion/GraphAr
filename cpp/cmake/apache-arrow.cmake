...
function(build_arrow)
    ...
    if (ARROW_VERSION_TO_BUILD GREATER_EQUAL "10.0.0")
    ...
    if (ARROW_VERSION_TO_BUILD GREATER_EQUAL "10.0.0")
        set(GAR_ARROW_DATASET_STATIC_LIB_FILENAME
	    "${CMAKE_STATIC_LIBRARY_PREFIX}arrow_dataset${CMAKE_STATIC_LIBRARY_SUFFIX}")
        set(GAR_ARROW_DATASET_STATIC_LIB "${GAR_ARROW_STATIC_LIBRARY_DIR}/${GAR_ARROW_DATASET_STATIC_LIB_FILENAME}" CACHE INTERNAL "dataset lib")
        set(GAR_ARROW_DATASET_LIBRARY_TARGET gar_dataset_static)
        add_library(${GAR_ARROW_DATASET_LIBRARY_TARGET} STATIC IMPORTED)
        set_target_properties(${GAR_ARROW_DATASET_LIBRARY_TARGET}
            PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${GAR_ARROW_INCLUDE_DIR}
            IMPORTED_LOCATION ${GAR_ARROW_DATASET_STATIC_LIB})
    endif()
